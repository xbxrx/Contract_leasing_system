			...
			for(var i = 0,rowLen = tableBody.length;i < rowLen; i++){//行遍历
				...
				for(var j = 0, fieldLen = tableHead.length; j < fieldLen; j++){
					...
					if(tableHead[j].minWidth){
						if(tableHeadJ.name){
							// tdArr.push('<td minWidth="minWidth" name="'+ tableHeadJ.name +'"><div class="ui-table-td" style="width:'+ (tableHeadJ.width -16) +'px">'+ rowData[tableHeadJ.name] +'</div></td>');
							tdArr.push('<td minWidth="minWidth" name="'+ tableHeadJ.name +'"><div class="ui-table-td" style="width:'+ (tableHeadJ.width -16) +'px">'+ 123123 +'</div></td>');
						}else{
							// tdArr.push('<td minWidth="minWidth"><div class="ui-table-td" style="width:'+ (tableHeadJ.width -17) +'px">'+ rowData[tableHeadJ.name] +'</div></td>');
							tdArr.push('<td minWidth="minWidth"><div class="ui-table-td" style="width:'+ (tableHeadJ.width -17) +'px">'+ 456 +'</div></td>');
						}
						
					}else{
						if(tableHeadJ.name){
							// tdArr.push('<td name="'+ tableHeadJ.name +'"><div class="ui-table-td" style="width:'+ (tableHead[j].width -17) +'px">'+ rowData[tableHeadJ.name] +'</div></td>');
							tdArr.push('<td name="'+ tableHeadJ.name +'"><div class="ui-table-td" style="width:'+ (tableHead[j].width -17) +'px">'+ 789 +'</div></td>');
						}else{
							// tdArr.push('<td><div class="ui-table-td" style="width:'+ (tableHead[j].width -17) +'px">'+ rowData[tableHeadJ.name] +'</div></td>');
							tdArr.push('<td><div class="ui-table-td" style="width:'+ (tableHead[j].width -17) +'px">'+ 12545 +'</div></td>');
						}
