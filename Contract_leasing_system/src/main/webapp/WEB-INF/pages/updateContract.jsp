...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-g">
                <form action="<%=basePath%>toUpdateResult" class="am-form am-form-horizontal" method="post"
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="doc-vld-ctn-1" required placeholder="请输入合同名称"
                                   name="contractName" value="${contractInfo.contractName}"> <small>输入合同名称</small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-sm-3 am-form-label">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="doc-vld-ctn-2" required placeholder="请输入甲方信息"
                                   name="partyA"  data-equal-to="#doc-vld-ctn-2" value="${contractInfo.partyA}" > <small>输入甲方信息。</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="doc-vld-ctn-3" required placeholder="请输入乙方信息"
                                   name="partyB"  data-equal-to="#doc-vld-ctn-3"  value="${contractInfo.partyB}"> <small>输入乙方信息。</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="doc-vld-ctn-4" required placeholder="请输入起始时间"
                                   name="startTime"  data-equal-to="#doc-vld-ctn-4"  value="${contractInfo.startTime}"> <small>输入起始时间。</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="doc-vld-ctn-5" required placeholder="请输入结束时间"
                                   name="deadline"  data-equal-to="#doc-vld-ctn-5"  value="${contractInfo.deadline}"> <small>输入结束时间。</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text " id="doc-vld-ctn-6" required placeholder="请输入租金金额"
                                   name="rent"  data-equal-to="#doc-vld-ctn-6"  value="${contractInfo.rent}"><br> <small>输入租金金额。</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        <div class="am-u-sm-9 am-u-sm-push-3">
                            ...
                            <button  class="am-btn am-btn-success">
                                <span ><a href="<%=basePath%>toCancel">返回</a></span>
                            </button>
                        </div>
                    </div>
